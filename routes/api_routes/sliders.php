...
Route::get('slider/show/{id}', [SliderController::class, 'show'])->name('sliders.show');

Route::post('sliders/store', [SliderController::class, 'store'])->name('sliders.store');
Route::post('slider/update/{slider}', [SliderController::class, 'update'])->name('sliders.update');
